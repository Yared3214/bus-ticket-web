...
<body>
    <div style="display: flex; flex-direction: column; align-items: center;">
        ...
        <?php } ?>
        <form action="registerBack.php" method="post" style="display: flex; flex-direction: column; gap: 10px;">
            ...
            <input type="password" name="password" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); width: 500px; height: 35px;
            border: none; font-size: 17px;" placeholder='Enter Your password'>
            <label>Confirm your password</label>
            <input type="password" name="cpassword" style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); width: 500px; height: 35px;
            ...
            <h4>Already have an account? <a href="../Login/login.php">Log in</a></h4>
        </form>
    </div>
</body>
